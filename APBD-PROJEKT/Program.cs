...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "RevenueRecognition API", Version = "v1" });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "RevenueRecognition API v1"));
}
